...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    # },
    labels[0] : {"texts" : ["중국식 냉면은 맛있어"], "images" : [] , "videos" : []},
    labels[1] : {"texts" : ["짜장면은 맛있어"], "images" : [] , "videos" : []},
    labels[2] : {"texts" : ["짬뽕은 맛있어"], "images" : [] , "videos" : []},
    labels[3] : {"texts" : ["탕수육은 맛있어"], "images" : [] , "videos" : []
}
